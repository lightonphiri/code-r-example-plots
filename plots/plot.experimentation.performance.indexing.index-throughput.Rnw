...
# import datafeeds
dataset <- read.table("../data/plot.experimentation.performance.indexing.index-throughput.dat", header=TRUE, sep=",")
...
# import datafeeds
index_size_dataset <- read.table("../data/plot.experimentation.performance.indexing.index-size.dat", header=TRUE, sep=",")
...
# import datafeeds
incremental_index_dataset <- read.table("../data/plot.experimentation.performance.indexing.index-update.dat", header=TRUE, sep=",")
