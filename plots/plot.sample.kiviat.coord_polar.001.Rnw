...
###tikz('../output/plot.sample.kiviat.coord_polar.001.tex', width=5.5, height=6.5)
tikz('../output/plot.sample.kiviat.coord_polar.001.tex')

# import datafeeds
dataset <- read.table("../data/plot.sample.kiviat.coord_polar.001.dat", header=TRUE, sep=",")
