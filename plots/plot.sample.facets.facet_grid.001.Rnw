...
###tikz('../output/plot.sample.facets.facet_grid.001.tex', width=5.5, height=7.5)
tikz('../output/plot.sample.facets.facet_grid.001.tex')

# import datafeeds
dataset <- read.table("../data/plot.sample.facets.facet_grid.001.dat", header=TRUE, sep=",")
